...
<html lang="en">
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_produk.php" class="btn btn-success mt-3">TAMBAH PRODUK</a>
        <a href="xml.php" class="btn btn-success mt-3">XML</a>
        <a href="json.php" class="btn btn-success mt-3">JSON</a>
        <div class="row">
