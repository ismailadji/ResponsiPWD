  ...
  <!-- Menu -->
    <div class="container">
      ...
      <form method="POST" action="">
        <a href="cetak_pesanan.php" class="btn btn-success btn-sm">Cetak</a>
        <a href="get_pesanan.php" class="btn btn-success btn-sm">Get Pesanan</a>
        <a href="akses_pesanan.php" class="btn btn-success btn-sm">Akses Pesanan</a>
      </form>
    </div>
  <!-- Akhir Menu -->
